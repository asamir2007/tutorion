...
package ttcc.v.wb.v {
	...
	public class DrawingObjectText extends DrawingObject {
		...
		private function el_mouse(e:MouseEvent):void {
			...
			//if (drawing) {return;}
			if ((drawingStage==DRAWINGSTAGE_DRAW_TF)||(drawingStage==DRAWINGSTAGE_EDIT_TF)) {
				return;
			}
		...
		public override function deserialize(a:Object):void {
			...
			x=a.x;y=a.y;x1=a.x1;y1=a.y1;color=a.c;thickness=a.t;text=a.text;
			project();
			drawingStage=DRAWINGSTAGE_END;
		}
		public override function serialize():Object {
			return {type:TYPE_NAME, x:dt.x, y:dt.y, x1:dt.width, y1:dt.height, c:color, t:thickness, text:dt.text};
		}
		//} =*^_^*= END OF model
