	...
	public class MACWhiteboard extends MAPPComponent {
		...
		protected override function prepareBeforeStartup():void {
			...
			var reslist:Array=[
				...
				,[VCWB.ID_ELEMENT_ICON_B_NEXT, 'next_w', 'next_b', 'next_p']
				,[VCWB.ID_ELEMENT_ICON_B_PREV, 'prev_w', 'prev_b', 'prev_p']
				
				,[VCWB.ID_ELEMENT_ICON_ADD_PAGE_W, 'add_page_w', 'add_page_w', 'add_page_w']
				,[VCWB.ID_ELEMENT_ICON_CIRCLE_W, 'circle_w', 'circle_w', 'circle_w']
				,[VCWB.ID_ELEMENT_ICON_RECT_W, 'rect_w', 'rect_w', 'rect_w']
				,[VCWB.ID_ELEMENT_ICON_ELLIPSE_W, 'ellipse_w', 'ellipse_w', 'ellipse_w']
				,[VCWB.ID_ELEMENT_ICON_CLEAN_PAGE_W, 'clean_page_w', 'clean_page_w', 'clean_page_w']
				,[VCWB.ID_ELEMENT_ICON_CLEAN_W, 'clean_w', 'clean_w', 'clean_w']
				,[VCWB.ID_ELEMENT_ICON_COLOR, 'color', 'color', 'color']
				,[VCWB.ID_ELEMENT_ICON_DELETE_ALL_W, 'delete_all_w', 'delete_all_w', 'delete_all_w']
				,[VCWB.ID_ELEMENT_ICON_ERASE_W, 'erase_w', 'erase_w', 'erase_w']
				,[VCWB.ID_ELEMENT_ICON_FONT, 'font', 'font', 'font']
				,[VCWB.ID_ELEMENT_ICON_LINE_W, 'line_w', 'line_w', 'line_w']
				...
				,[VCWB.ID_ELEMENT_ICON_REMOVE_PAGE_W, 'remove_page_w', 'remove_page_w', 'remove_page_w']
				,[VCWB.ID_ELEMENT_ICON_SAVE_W, 'save_w', 'save_w', 'save_w']
				,[VCWB.ID_ELEMENT_ICON_TEXT_W, 'text_w', 'text_w', 'text_w']
				,[VCWB.ID_ELEMENT_ICON_UNDO_W, 'undo_w', 'undo_w', 'undo_w']
				,[VCWB.ID_ELEMENT_ICON_UPLOAD_W, 'upload_w', 'upload_w', 'upload_w']
				,[VCWB.ID_ELEMENT_ICON_ZOOM_M_W, 'zoom_m_w', 'zoom_m_w', 'zoom_m_w']
				,[VCWB.ID_ELEMENT_ICON_ZOOM_P_W, 'zoom_p_w', 'zoom_p_w', 'zoom_p_w']
