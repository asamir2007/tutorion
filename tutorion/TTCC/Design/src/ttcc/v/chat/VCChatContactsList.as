package ttcc.v.chat {
	...
	public class VCChatContactsList extends JPanel {
		 ...
		 */
		function VCChatContactsList (eventsPipe:Function, enableBanFeature:Boolean, elementWidth:uint=150, elementHeight:uint=20) {
			super(new BorderLayout());
			this.enableBanFeature=enableBanFeature;
		...
		public function addElement(displayName:String, avatarImage:DisplayObject, id:uint, selected:Boolean, userID:String):void {
			...
			//for (var i:int = 0; i < 24;i++) {
				var item:VCChatContactsListElement = new VCChatContactsListElement(id, defaultEventsPipe, eW, eH, avatarImage, displayName, selected, userID, enableBanFeature);
				itemsList.push(item);
...
*/		
		...
		private var enableBanFeature:Boolean;
