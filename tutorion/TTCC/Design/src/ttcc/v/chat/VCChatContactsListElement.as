package ttcc.v.chat {
	...
	public class VCChatContactsListElement extends JPanel {
		 ...
		 */
		function VCChatContactsListElement (id_:uint, eventsPipe:Function, w:uint, h:uint, avatarImg:DisplayObject, displayName:String, selected:Boolean, userID:String, enableBanFeature:Boolean) {
			setSizeWH(w,h);
			...
			//img.setToolTipText(displayName+'\n'+APP.lText().get_TEXT(Text.ID_TEXT_CHAT_BAN_BUTTON));
