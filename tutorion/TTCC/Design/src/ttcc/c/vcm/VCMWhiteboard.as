...
package ttcc.c.vcm {
	...
	public class VCMWhiteboard extends AVCM {
		...
		public override function listen(eventType:String, details:Object):void {
			...
			case ID_A_SET_POSITION:
				vc.setZoomPosition(details[0], details[1]);
				break;
			case ID_A_SET_ZOOM:
				vc.setZoom(details);
				break;
		...
		private function configureVC():void {
			...
			vc.construct();
			var m:Boolean=a.get_ds().get_replayMode()||!a.get_ds().get_clientUserData().get_isLector();
			var m0:Boolean=!a.get_ds().get_replayMode()&&a.get_ds().get_clientUserData().get_isLector();
			vc.setUintOutput(VCWB.ID_OUT_UINT_DISPLAY_MODE, uint(m));
			vc.setToggleButtonVisibility(m0);
		}
		...
		private function el_vc(target:VCWB, eventType:String, details:Object=null):void {
			...
			case VCWB.ID_E_SELECT_THICKNESS:
				get_envRef().listen(ID_E_SELECT_THICKNESS, details.thickness);
				break;
			case VCWB.ID_E_SELECT_COLOR:
				get_envRef().listen(ID_E_SELECT_COLOR, details.color);
				break;
			...
			case VCWB.ID_E_B_WB_SAVE:
				...
				break;
			case VCWB.ID_E_B_TOOL_ZOOM:
				// proxy
				get_envRef().listen(ID_E_SET_ZOOM, details);
				break;
			case VCWB.ID_E_SET_POSITION:
				// proxy
				get_envRef().listen(ID_E_SET_POSITION, details);
				break;
		 ...
		 * int
		 */
		public static const ID_A_SET_ZOOM:String=NAME+'>ID_A_SET_ZOOM';
		/**
		 * [x,y]
		 */
		public static const ID_A_SET_POSITION:String=NAME+'>ID_A_SET_POSITION';
		/**
		 * data:VCWB
		 */
		 ...
		 * data:{thickness:int}
		 */
		public static const ID_E_SELECT_THICKNESS:String = NAME + '>ID_E_SELECT_THICKNESS';	
		/**
		 * data:{color:int}
		 */
		public static const ID_E_SELECT_COLOR:String = NAME + '>ID_E_SELECT_COLOR';
		 ...
		 * int
		 */
		public static const ID_E_SET_ZOOM:String = NAME + '>ID_E_SET_ZOOM';
		/**
		 * [x,y]
		 */
		public static const ID_E_SET_POSITION:String=NAME+'>ID_E_SET_POSITION';
		//} =*^_^*= END OF id
