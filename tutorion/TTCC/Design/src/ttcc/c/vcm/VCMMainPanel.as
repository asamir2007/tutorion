...
package ttcc.c.vcm {
	...
	public class VCMMainPanel extends AVCM {
		...
		private function configureVC():void {
			...
			vc.setBGColor(0x999999, 0);
			vc.setListener(el_vc);
			//LOG(0, 'setW()>vc.get_displayObject().stage.stageWidth='+vc.get_displayObject().stage.stageWidth,1)
			vc.setW(vc.get_displayObject().stage.stageWidth);
		}
		...
		private function addComponentButton(b:DUMPButton):void {
			...
			cB.construct(
				...
				,[
					...
					,PictureStoreroom.getPicture(b.get_iconOver())
					,PictureStoreroom.getPicture(b.get_iconDown())
				]
			);
