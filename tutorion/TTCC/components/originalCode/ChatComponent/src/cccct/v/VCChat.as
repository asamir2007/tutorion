package cccct.v {
	...
	import org.jinanoimateydragoncat.works.cyber_modules.v.BaseVC;
	 ...
	 */
	public class VCChat extends BaseVC {
		
		//{ =*^_^*= CONSTRUCTOR
		
		public function construct(eventsPipe:Function, contactsButtonImage:DisplayObject, enterButtonImage:DisplayObject, contactsList:VCChatContactsList, wndMinW:uint=300, wndMinH:uint=200, inputTextMinH:uint=25,inputTextMaxH:uint=50):void {
			if (!contactsList) {
		...
		*/
		...
		private var wnd_title:String='chat';
		...
		private function configureControll():void {
			// TODO: add listeners and other control
		}
		...
		//{ =*^_^*= events
		/**
		 * @param	listener function (eventType:String, details:Object):void;
		 */
