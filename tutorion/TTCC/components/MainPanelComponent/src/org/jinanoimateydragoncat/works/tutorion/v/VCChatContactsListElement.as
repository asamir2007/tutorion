package org.jinanoimateydragoncat.works.tutorion.v {
	 ...
	 */
	public class VCMainPanelContactsListElement extends JPanel {
		 ...
		 * @param	id_
		 * @param	eventsPipe function (target:VCMainPanelContactsListElement, eventType:String):void; see events section for more details
		 */
		function VCMainPanelContactsListElement (id_:uint, eventsPipe:Function, w:uint, h:uint, avatarImg:DisplayObject, displayName:String, selected:Boolean) {
			setSizeWH(w,h);
